...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		autoChooser.addDefault("Drive 1 sec", new Drive(1, 0));
		...
		autoChooser.addObject("turn left",new turnLeft());
		autoChooser.addObject("turn right",new turnRight());
		autoChooser.addObject("turn around left",new turnAroundLeft());
		autoChooser.addObject("turn around right",new turnAroundRight());
		autoChooser.addObject("liftPicker test (1 sec)", new liftPicker(5));
		autoChooser.addObject("lowerPicker test (1 sec)", new lowerPicker(1));
		autoChooser.addObject("lowerPicker test limit switch", new lowerPicker());
		//autoChooser.addObject("lowerPicker test (1 sec)", new lowerPicker(1));
