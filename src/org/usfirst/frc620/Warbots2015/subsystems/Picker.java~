...
public class Picker extends Subsystem {
    ...
    DigitalInput limitSwitchBottom = RobotMap.pickerlimitSwitchBottom;
    SpeedController pickerMotor = RobotMap.pickerPickerMotor;
    DigitalInput limitSwitchTop = RobotMap.pickerlimitSwitchTop;
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new movePicker());
